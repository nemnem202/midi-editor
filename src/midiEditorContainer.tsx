...
import MidiEditorLoader from "./midiEditor";
...
export default function MidiEditorContainerContainer({ initProject }: { initProject: Project }) {
        ...
        >
          <div className="relative size-full flex flex-col gap-2">
            ...
            <div className="relative size-full">
              ...
              <MidiEditorLoader hasClicked={hasClicked} setClicked={setClicked}>
